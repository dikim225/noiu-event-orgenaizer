...
<body>
    ...
    <nav class="fixed-top shadow">
        <a class="navbar-brand logo" href="home.html"><img src="assets/image/noiu.png" height="60" style="margin-top:
                    10px;" /></a>
        ...
        <ul>
            ...
            <li>
                <label for="btn-1" class="show">Paket Outbound dan Gathering
                    +</label>

                <a href="#">Paket Outbound dan Gathering</a>
                <input type="checkbox" id="btn-1">
                <ul>
                    <li><a href="paket.html">Outbound</a></li>
                    <li><a href="gethering.html">Gethering</a></li>
                    <li><a href="wisata.html">Wisata sumedang</a></li>
                </ul>
            </li>
    ...
    if (isset($_GET['edit'])) {
        ...
        $kueri_edit = mysqli_query($koneksi, $sql_edit);
        $data_edit = mysqli_fetch_array($skueri_edit);

        $action_from = 'fungsi_edit.php';
    } else {
            ...
            <div class="row pt-4">
                <div class="col-lg-4 pt-5 ">
                    <h5 class="fw-bold text-primary ">
                        NOIU EVENT ORGENAIZER
                    </h5>
                    <h6 class="pt-2 ">Alamat Kantor:</h6>
                    <p class="">Jl. Bukit Nuur No.C36, Cinunuk, Kec.
                        Cileunyi,
                        Kabupaten
                        Bandung, Jawa Barat 40624</p>
                    <h6 class="pt-2 ">WathsApp CS:</h6>
                    <p class="">+621221364081 (Office Hour)</p>
                    <h6 class="pt-2 ">Email :</h6>
                    <p class="">-</p>
                </div>
                <div class="col-lg-4 pt-5">
                    <h5 class=" fw-bold text-primary ">JAM
                        OPERASIONAL</h5>
                    <h6 class="pt-2 ">Senin - Sabtu:</h6>
                    <p class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" style="margin-bottom:5 ;"
                            fill="currentColor" class="bi bi-clock" viewBox="0 0
                                    16 16">
                            <path d="M8 3.5a.5.5 0 0 0-1 0V9a.5.5 0
                                        0 0
                                        .252.434l3.5 2a.5.5 0 0 0
                                        .496-.868L8
                                        8.71V3.5z" />
                            <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0
                                            0 0
                                            16zm7-8A7 7 0 1 1 1 8a7 7 0 0 1
                                            14 0z" />
                        </svg> 08.00 - 16.00
                    </p>
                    <h6 class="pt-3 ">Minggu/Libur Nasiona:</h6>
                    <p class="">Tutup</p>
                </div>
                <div class="col-lg-4 pt-5">
                    <h5 class=" fw-bold text-primary ">TEMUKAN
                        NOIU</h5>
                    <p class="pt-2 ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi
                            ...
                            <path d="M8 0C5.829 0 5.556.01
                                                4.703.048
                                                3.85.088
                                                3.269.222 2.76.42a3.917
                                                3.917 0 0
                                                0-1.417.923A3.927 3.927 0 0
                                                0 .42
                                                2.76C.222
                                                3.268.087 3.85.048 4.7.01
                                                5.555 0
                                                5.827
                                                0
                                                8.001c0 2.172.01 2.444.048
                                                3.297.04.852.174
                                                1.433.372
                        ...
                        Instagram: <a style="color:
                                                white;" target="_blank"
                            href="https://instagram.com/noiu.eo?igshid=YmMyMTA2M2Y=">noiu.eo</a>
                    </p>
                    <p class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi
                                                bi-youtube" viewBox="0 0 16
                                                16">
                            <path d="M8.051
                                                    1.999h.089c.822.003
                                                    4.987.033
                                                    6.11.335a2.01 2.01 0 0 1
                                                    1.415
                                                    1.42c.101.38.172.883.22
                                                    1.402l.01.104.022.26.008.104c.065.914.073
                                                    1.77.074
                                                    1.957v.075c-.001.194-.01
                                                    1.108-.082
                                                    2.06l-.008.105-.009.104c-.05.572-.124
                                                    1.14-.235
                                                    1.558a2.007 2.007 0 0
                                                    1-1.415
                                                    ...
                                                    99.788 0 0 1 7.858
                                                    2h.193zM6.4
                                                    5.209v4.818l4.157-2.408L6.4
                                                    5.209z" />
                        </svg>
                        Youtube: <a style="color:white ;" target="_blank"
                            href="https://www.youtube.com/channel/UCL1XKI6TXQ9O3tp2pL93ZOQ">NOIU</a>
                    </p>
                    <p class="1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi
                                                    bi-tiktok" viewBox="0 0 16 16">
                            <path d="M9
                                                        0h1.98c.144.715.54
                                                        1.617
                                                        1.235
                        ...
                        Tik Tok: <a style="color:white;" target="_blank"
                            href="https://www.tiktok.com/@noiu.eo">Noiu.eo</a>
                    </p>
                    <img src="assets/image/logo.png" class="rounded
                                                    float-end pt-5" alt="..." style="width:
                                                    10rem;">
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12
                    ...
                    <a type="button" class="btn
                                                    btn-success"
                        href="https://wa.me/6285322835173?text=Hallo%20NOIU%20!" target="_blank"
                        style="background-color:#25d366;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
